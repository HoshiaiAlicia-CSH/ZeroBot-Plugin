// Package main ZeroBot-Plugin main filee
package main
...
func init() {
	...
	token := flag.String("t", "dashun1664", "Set AccessToken of WSClient.")
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "李自成","李哥" ),
